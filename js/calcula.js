...
function borradoTotal() {
         ...
         //Es una conversión a binario por medio de la codificación de un algoritmo 
function binario() {
        let bin=0;
        let rem,i=1,step=1;
        while(x!=0){
...
//Conversion a binario con toString
/*      function binario() {
        let bin=parseInt(x,10).toString(2);
        pantalla.innerHTML=bin;   
        }*/
        //Esta es la conversión a octal utilizando un algoritmo, mismo que posteriormente se codificó
function octal() {
        let oct=0;
        let rem,i=1,step=1;
        while(x!=0){
        ...
        pantalla.innerHTML=oct;
        op="no"; //quitar operaciones pendientes.
         xi=1; //se puede reiniciar la pantalla 
        } 
        //Esta es la conversión a hexadecimal utilizando toString
